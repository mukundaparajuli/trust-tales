    ...
    return (
        ...
        >
            ...
            <svg ref={svgRef} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 400" width={400} height={600}>
                {/* Minimalist Dark Card Background */}
                ...
                <foreignObject x="40" y="60" width="220" height="160">
                    <div style={{ fontFamily: 'Arial', fontSize: '14px', color: '#E5E7EB', lineHeight: 1.6, textAlign: 'justify' }}>
                        {message}
                    </div>
                </foreignObject>

                {/* Avatar Image */}
                <image x="110" y="220" width="80" height="80" href={photo} clipPath="url(#circleClip1)" />
